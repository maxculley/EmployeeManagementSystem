...
CREATE TABLE `employee_holidays` (
  `holiday_id` int(4) AUTO_INCREMENT,
  `employee_id` int(4) NOT NULL,
  `start_date` date NOT NULL,
  PRIMARY KEY (`holiday_id`)
  ) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
  INSERT INTO `employee_holidays` VALUES (1,1001, 2020-12-12);
  INSERT INTO `employee_holidays` VALUES (2,1002, 2021-01-26);
  INSERT INTO `employee_holidays` VALUES (3, 1003, 2020-12-25)s;
